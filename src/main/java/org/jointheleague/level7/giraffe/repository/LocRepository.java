...
//                //    .getFinalResult();
//
//            System.out.println(baseUrl + "alignment/" + tempMod);
//
//            return results;
...
//            return results;
//        }
//        if(query.contains("alignment")) {
//            String tempMod = modified.replace("feature", "").toLowerCase(Locale.ROOT).trim().replace(" ", "-");
//
//            LocResponse result = webClient.get()
//                    .uri(uriBuilder -> uriBuilder.query("ability-scores/" + tempMod).build()
//                    ).retrieve()
//                    .bodyToMono(LocResponse.class)
//                    .block()
...
//    }
        public LocResponse getResults(String query){
            String tempMod = query.replace("alignment", "").toLowerCase(Locale.ROOT).trim().replace(" ", "-");
            return webClient.get()
                    .uri(uriBuilder -> uriBuilder
                            .queryParam("alignments/", tempMod)
                            .build()
                    ).retrieve()
                    .bodyToMono(LocResponse.class)
                    .block()
